...
function twentyten_setup() {
	...
	add_image_size( 'featured-thumb', 153, 153, true );
	add_image_size( 'page-banner', 630, 355, true );
	add_image_size( 'slider', 960, 424, true );
...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'sidebar',
		'description' => __( 'Sidebar', 'twentyten' ),
...
function pagenavi($before = '', $after = '') {
    ...
    $pagenavi_options['prev_text'] = 'Prev';
...
function remove_footer_admin () {
	echo '&copy; 2012 - Created by <a href="http://www.miniman-webdesign.co.uk">Miniman Web Design</a>';
}
add_filter('admin_footer_text', 'remove_footer_admin');

/***************************************************
/ MINIMAN DASHBOARD WIDGET
/***************************************************/

function wpc_dashboard_widget_function() {
	?>
        <ul class="miniman-credit">
            <li>For further information and support please visit us at <a href="http://www.miniman-webdesign.co.uk">Miniman Web Design</a></li>
            <li>or feel free to contact us at <a href="mailto:support@miniman-webdesign.co.uk">support@miniman-webdesign.co.uk</a></li>
            <li>&copy; <?php echo date("Y") ?> Miniman Web Design</li>
        </ul>
	<?php ;
}
function wpc_add_dashboard_widgets() {
	wp_add_dashboard_widget('wp_dashboard_widget', 'Created by Miniman Web Design', 'wpc_dashboard_widget_function');
}
